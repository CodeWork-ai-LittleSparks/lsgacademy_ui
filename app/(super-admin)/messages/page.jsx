          ...
          <div className="w-96 border-r border-gray-200 flex flex-col">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="border-b border-gray-200">
              <TabsList className="w-full justify-start h-14 bg-transparent px-6">
                <TabsTrigger value="all" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-100 data-[state=active]:to-blue-100">All</TabsTrigger>
                <TabsTrigger value="direct" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-100 data-[state=active]:to-blue-100">Direct</TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            {selectedConversationId ? (
              ...
              <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-50 to-blue-50/30">
                <div className="text-center space-y-4">
                  <div className="inline-block p-5 bg-gradient-to-br from-purple-100 to-blue-100 rounded-2xl shadow-lg">
                    <MessageCircle className="h-12 w-12 text-purple-600" strokeWidth={2.5} />
                  </div>
                  <div>
